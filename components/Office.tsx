...
export default function Office() {
  return (
    <section className="bg-office py-16 md:py-24">
      <div className="mx-auto max-w-7xl px-6 md:px-12 lg:px-16">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-24">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p
              className="mb-8 font-subheading text-lg leading-relaxed text-[#223614] md:text-xl"
            ...
            <div
              className="space-y-4 font-subheading text-base text-[#223614]/80"
              style={{ fontFamily: "var(--font-lato)" }}
            >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="relative h-64 w-full overflow-hidden rounded-tr-[80px] md:h-80 xl:-translate-y-6">
              <Image
                src="/office1.jpeg"
            ...
            <div className="relative mt-12 h-64 w-full overflow-hidden rounded-bl-[80px] md:h-80 xl:translate-y-6">
              <Image
                src="/office2.jpeg"
